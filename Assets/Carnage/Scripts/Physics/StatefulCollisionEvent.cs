...
namespace Unity.Physics.Stateful
{
    ...
    public struct StatefulCollisionEventH : IStatefulSimulationEvent<StatefulCollisionEventH>
    {
        ...
        public StatefulCollisionEventH(CollisionEvent collisionEvent)
        {
        ...
        public int CompareTo(StatefulCollisionEventH other) => ISimulationEventUtilities.CompareEvents(this, other);
    }
}
