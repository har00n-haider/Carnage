...
namespace Unity.Physics.Stateful
{
    ...
    public partial class StatefulCollisionEventBufferSystem : SystemBase
    {
        ...
        private StatefulSimulationEventBuffers<StatefulCollisionEventH> m_StateFulEventBuffers;
        ...
        protected override void OnCreate()
        {
            ...
            m_Query = GetEntityQuery(new EntityQueryDesc
            {
                ...
                {
                    typeof(StatefulCollisionEventH)
                }
            });

            m_StateFulEventBuffers = new StatefulSimulationEventBuffers<StatefulCollisionEventH>();
        }
        ...
        protected override void OnUpdate()
        {
            ...
            Entities
                ...
                .WithBurst()
                .ForEach((ref DynamicBuffer<StatefulCollisionEventH> buffer) =>
                {
                    buffer.Clear();
                }).ScheduleParallel();
            ...
            var eventBuffers = GetBufferFromEntity<StatefulCollisionEventH>();
            ...
            Job
                ...
                .WithCode(() =>
                {
                    var statefulEvents = new NativeList<StatefulCollisionEventH>(currentEvents.Length, Allocator.Temp);

                    StatefulSimulationEventBuffers<StatefulCollisionEventH>.GetStatefulEvents(previousEvents, currentEvents, statefulEvents);
