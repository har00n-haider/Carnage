...
namespace Unity.Physics.Stateful
{
    ...
    public partial class StatefulTriggerEventBufferSystem : SystemBase
    {
        ...
        private StatefulSimulationEventBuffers<StatefulTriggerEventH> m_StateFulEventBuffers;
        ...
        protected override void OnCreate()
        {
            ...
            m_StateFulEventBuffers = new StatefulSimulationEventBuffers<StatefulTriggerEventH>();
        }
        ...
        protected override void OnUpdate()
        {
            ...
            Entities
                ...
                .ForEach((ref DynamicBuffer<StatefulTriggerEventH> buffer) =>
                {
                    buffer.Clear();
                }).ScheduleParallel();
            ...
            var eventBuffers = GetBufferFromEntity<StatefulTriggerEventH>();
            ...
            Job
                ...
                .WithCode(() =>
                {
                    var statefulEvents = new NativeList<StatefulTriggerEventH>(currentEvents.Length, Allocator.Temp);

                    StatefulSimulationEventBuffers<StatefulTriggerEventH>.GetStatefulEvents(previousEvents, currentEvents, statefulEvents, true);
