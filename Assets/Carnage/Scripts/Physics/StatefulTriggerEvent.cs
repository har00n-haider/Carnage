...
namespace Unity.Physics.Stateful
{
    ...
    public struct StatefulTriggerEventH :  IStatefulSimulationEvent<StatefulTriggerEventH>
    {
        ...
        public StatefulTriggerEventH(TriggerEvent triggerEvent)
        {
        ...
        public int CompareTo(StatefulTriggerEventH other) => ISimulationEventUtilities.CompareEvents(this, other);
    }
}
