...
namespace Unity.Physics.Stateful
{
    ...
    public static class StatefulEventCollectionJobs
    {
        ...
        {
            public NativeList<StatefulTriggerEventH> TriggerEvents;
            public void Execute(TriggerEvent triggerEvent) => TriggerEvents.Add(new StatefulTriggerEventH(triggerEvent));
        }

        [BurstCompile]
        public struct CollectCollisionEvents : ICollisionEventsJob
        {
            public NativeList<StatefulCollisionEventH> CollisionEvents;
            public void Execute(CollisionEvent collisionEvent) => CollisionEvents.Add(new StatefulCollisionEventH(collisionEvent));
        }
        ...
        public struct CollectCollisionEventsWithDetails : ICollisionEventsJob
        {
            ...
            {
                var statefulCollisionEvent = new StatefulCollisionEventH(collisionEvent);
                ...
                if (calculateDetails)
                {
                    ...
                    statefulCollisionEvent.CollisionDetails = new StatefulCollisionEventH.Details(
